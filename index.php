                ...
                <div class="max-w-md w-full px-6 py-8 rounded-lg shadow-lg bg-card">
                    ...
                    <div class="mb-6">
                        <label for="length" class="flex items-center">
                            <input name="length" id="length" class="flex h-10 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 mr-4 w-20 text-center" min="6" max="50" type="number" value="<?php echo isset($_POST['length']) ? $_POST['length'] : '12'; ?>" />
